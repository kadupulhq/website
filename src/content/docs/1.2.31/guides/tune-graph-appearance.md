...
[Graph items](/1.2.31/reference/graph-items/); the types that matter for readability are
these.
...
alone hides saturation. See [Read your first graph](/1.2.31/start/first-graph/) for why.
