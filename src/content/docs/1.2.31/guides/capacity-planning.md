...
description: Work out the disk, memory, poll window and database size an install
...
policy. See [Manage data retention](/1.2.31/guides/manage-data-retention/).
...
[High volume writes](/1.2.31/concepts/high-volume-writes/) explains the shape of it and
...
[Spine, the C collector](/1.2.31/reference/spine/) has the difference in full.
...
[Scale the poller](/1.2.31/guides/scale-the-poller/) covers which limit you actually hit.
...
lost. See [Tune database performance](/1.2.31/guides/tune-database-performance/).
...
| Connection formula | [Scale the poller](/1.2.31/guides/scale-the-poller/) |
...
[Monitor Kadupul itself](/1.2.31/guides/monitor-kadupul-itself/) for which of these
numbers the system already records about itself, and
[Tune database performance](/1.2.31/guides/tune-database-performance/) for the per-table
size report.
