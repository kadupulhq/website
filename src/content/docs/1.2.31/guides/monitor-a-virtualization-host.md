...
description: What a hypervisor exposes over SNMP, what ships for ESXi, and why
...
[Write a data collection script](/1.2.31/guides/write-a-data-collection-script/).
...
Linux host answers with. See [Monitor a Linux server](/1.2.31/guides/monitor-a-linux-server/)
...
it is a candidate for more threads. See [Scale the poller](/1.2.31/guides/scale-the-poller/).
...
reconfiguration can renumber them. See [Monitor a switch](/1.2.31/guides/monitor-a-switch/) for
...
See [The poller cache](/1.2.31/concepts/the-poller-cache/).
