...
description: What an upgrade actually changes, which parts can be rolled back,
  and the one part that cannot.
banner:
...
the intended procedure, based on the application behavior.
:::
...
[Back up and restore](/1.2.31/guides/back-up-and-restore/). An upgrade is the one time
...
[Data sources and round-robin archives](/1.2.31/concepts/data-sources-and-rras/) for why
