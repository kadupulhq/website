...
description: Why access is split into two independent systems, why a permission
  is stored as a default plus exceptions, and why a tree looks different to
  every account.
banner:
...
sidebar:
  order: 8
slug: 1.2.31/concepts/permissions-and-access
---
...
account, see [Manage users and permissions](/1.2.31/guides/manage-users-and-permissions/).
...
policy says nothing about. See [Plugins](/1.2.31/concepts/plugins/).
