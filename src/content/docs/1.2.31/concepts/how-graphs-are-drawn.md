...
[Graph items](/1.2.31/reference/graph-items/).
...
large and is listed in full in [Graph items](/1.2.31/reference/graph-items/): arithmetic, comparison and conditional operators, trigonometry, aggregation
