...
[Monitor a switch](/1.2.31/guides/monitor-a-switch/).
...
[SNMP](/1.2.31/reference/snmp/) has the credential fields.
...
The full list of methods is in [Add your first device](/1.2.31/start/first-device/).
...
see an empty device, and conclude the template failed. [Templates](/1.2.31/concepts/templates/)
...
[Manage data retention](/1.2.31/guides/manage-data-retention/), and the whole-system version
is [Capacity planning](/1.2.31/guides/capacity-planning/).
...
[Data queries and indexes](/1.2.31/concepts/data-queries-and-indexes/) has the identity
argument in full.
...
operation. [Discover devices automatically](/1.2.31/guides/discover-devices-automatically/)
...
device problem. See [Logging](/1.2.31/reference/logging/).
...
[File layout](/1.2.31/reference/file-layout/) has where it lives.
...
work [Troubleshoot missing data](/1.2.31/guides/troubleshoot-missing-data/) from step 4,
...
[Read your first graph](/1.2.31/start/first-graph/) covers all three properly, and
[How graphs are drawn](/1.2.31/concepts/how-graphs-are-drawn/) explains why the same stored
...
| A tree placement | Before the device count passes what a list can hold. [Organize devices with trees](/1.2.31/guides/organize-devices-with-trees/) |
| Permissions | Before anyone but you logs in. [Manage users and permissions](/1.2.31/guides/manage-users-and-permissions/) |
| Deferred RRD writes | When storage is the limit, not before. [High volume writes](/1.2.31/concepts/high-volume-writes/) |
| A second data collector | When the collecting side is the limit. [Scale the poller](/1.2.31/guides/scale-the-poller/) |
| Custom templates | When nothing shipped fits. [Create custom templates](/1.2.31/guides/create-custom-templates/) |
...
* Decisions 2, 3 and 4 become device template and discovery rule settings. See
  [Discover devices automatically](/1.2.31/guides/discover-devices-automatically/).
...
* Decision 12 becomes something you watch continuously rather than once. See
  [Monitor Kadupul itself](/1.2.31/guides/monitor-kadupul-itself/).
