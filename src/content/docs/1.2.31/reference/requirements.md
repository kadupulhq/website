...
required. Which path a given call takes is in [SNMP](/1.2.31/reference/snmp/).
...
Details are in [RRDtool integration](/1.2.31/reference/rrdtool-integration/).
...
one is on it, is in [File layout](/1.2.31/reference/file-layout/).
