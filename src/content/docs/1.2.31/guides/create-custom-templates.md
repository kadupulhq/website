...
description: How to build a data template and a graph template by hand, when to
...
Read [Templates](/1.2.31/concepts/templates/) first if the four template kinds are not yet
distinct to you.
