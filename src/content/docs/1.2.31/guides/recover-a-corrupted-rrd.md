...
description: How to tell a damaged round-robin archive from a misconfigured one,
...
| Graph is empty but no error | No value has ever been written | [Troubleshoot missing data](/1.2.31/guides/troubleshoot-missing-data/) |
...
| Values are present and all unknown | Collection failure, not corruption | [Troubleshoot missing data](/1.2.31/guides/troubleshoot-missing-data/) |
...
[Data sources and archives](/1.2.31/concepts/data-sources-and-rras/) and
[Manage data retention](/1.2.31/guides/manage-data-retention/). Raising a maximum with `tune`
...
[removing spikes](/1.2.31/guides/remove-spikes-from-data/).
