...
description: The six ways Kadupul collects a value, the input and output fields
  each one takes, and the output each one must return.
banner:
  content: Kadupul has not shipped. These pages describe the system as it is
    intended to ship.
sidebar:
  order: 10
slug: 1.2.31/reference/data-input-methods
---
