---
title: Plugins
description: Why the extension surface is a list of named call-out points, what
...
See [Permissions and access](/1.2.31/concepts/permissions-and-access/).
...
inferring them. See [Remote data collection](/1.2.31/concepts/remote-data-collection/).
