...
description: The elements of a data query resource file, the field attributes
  for SNMP and script queries, and how the parser reads them.
banner:
  content: This is inherited 1.2.31 documentation. A supported Kadupul release
    or migration path is not yet available. Validate procedures before use.
sidebar:
  order: 14
slug: 1.2.31/reference/data-query-xml
---
...
[Data input methods](/1.2.31/reference/data-input-methods/).
...
is chosen, is in [Data queries and indexes](/1.2.31/concepts/data-queries-and-indexes/).
