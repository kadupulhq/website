...
drawn](/1.2.31/concepts/how-graphs-are-drawn/). You do not need it today. You need to know
...
flapping. [Time and intervals](/1.2.31/concepts/time-and-intervals/) covers the arithmetic.
...
[Troubleshoot missing data](/1.2.31/guides/troubleshoot-missing-data/) takes the same path
in more depth. [Tune graph appearance](/1.2.31/guides/tune-graph-appearance/) covers
...
can read. From here, [How-to guides](/1.2.31/guides/monitor-a-switch/) handle specific
jobs, and [Concepts](/1.2.31/concepts/architecture/) explain why the system behaves the
way it does.
