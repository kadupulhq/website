...
| `boost_redirect` | Enable direct population of poller\_output\_boost table | Insert straight into `poller_output_boost`, which the source states cuts about 25 percent from each poll cycle. | boolean | |
...
useful. [Configuration](/1.2.31/reference/configuration/) lists them.
