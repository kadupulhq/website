...
[Configuration](/1.2.31/reference/configuration/).
...
would for `cmd.php`. See [Poller lifecycle](/1.2.31/reference/poller-lifecycle/) for the
surrounding run.
...
[Scale the poller](/1.2.31/guides/scale-the-poller/) comes from, and it is the first limit a
...
never talks to the [RRD proxy](/1.2.31/reference/rrdproxy/).
...
that deserve the treatment in [Security model](/1.2.31/concepts/security-model/): the
...
The [Scale the poller](/1.2.31/guides/scale-the-poller/) guide walks the measurement that
