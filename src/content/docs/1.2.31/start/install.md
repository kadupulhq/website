...
[Requirements](/1.2.31/reference/requirements/).
...
performance](/1.2.31/guides/tune-database-performance/) goes further once you have load.
...
[Remote data collection](/1.2.31/concepts/remote-data-collection/) covers it when you are.
Every other setting has a working default, so read
[Configuration](/1.2.31/reference/configuration/) before changing any of them.
...
[Logging](/1.2.31/reference/logging/) covers where each records itself. [Troubleshoot
missing data](/1.2.31/guides/troubleshoot-missing-data/) covers the case where the install
...
[Secure an internet-facing install](/1.2.31/guides/secure-an-internet-facing-install/) has
the rest. Next: [Add your first device](/1.2.31/start/first-device/).
