...
Commencez par une installation de test isolée, ajoutez un appareil et vérifiez l’arrivée des données avant d’interpréter les graphiques. Conservez des sauvegardes et testez leur restauration.

- [Installation](/fr/start/install/)
- [Ajouter un premier appareil](/fr/start/first-device/)
- [Lire un premier graphique](/fr/start/first-graph/)
